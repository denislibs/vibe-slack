...
export class WasmAddResult {
    static __wrap(ptr) {
        const obj = Object.create(WasmAddResult.prototype);
        obj.__wbg_ptr = ptr;
        WasmAddResultFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmAddResultFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmaddresult_free(ptr, 0);
    }
    /**
     * @returns {Uint8Array}
     */
    get commit() {
        const ret = wasm.wasmaddresult_commit(this.__wbg_ptr);
     ...
     */
    get welcome() {
        const ret = wasm.wasmaddresult_welcome(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
...
export class WasmEngine {
    ...
    add_member(group_id, key_package) {
        ...
        const ret = wasm.wasmengine_add_member(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmAddResult.__wrap(ret[0]);
    }
    /**
     * @param {string} group_id
     */
    create_group(group_id) {
        const ptr0 = passStringToWasm0(group_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmengine_create_group(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    /**
     * @param {string} group_id
     * @param {Uint8Array} compliance_kp
     * @returns {Uint8Array}
     */
    create_group_with_compliance(group_id, compliance_kp) {
        const ptr0 = passStringToWasm0(group_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(compliance_kp, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmengine_create_group_with_compliance(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[3]) {
    ...
    decrypt(group_id, message) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmengine_decrypt(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    ...
    encrypt(group_id, plaintext) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmengine_encrypt(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    ...
    join_from_welcome(welcome) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmengine_join_from_welcome(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    key_package_bytes() {
        const ret = wasm.wasmengine_key_package_bytes(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
const WasmAddResultFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmaddresult_free(ptr, 1));
